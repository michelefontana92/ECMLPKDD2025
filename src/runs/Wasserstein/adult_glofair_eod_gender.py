...
@register_run('wasserstein_adult_glofair_eod_gender')
class WassersteinAdultGlofairEODGenderRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(WassersteinAdultGlofairEODGenderRun, self).__init__(**kwargs)
        self.project_name = 'CentralizedWassersteinAdultGlofairEODGender'
        self.num_clients = 10
        self.lr=1e-4
        ...
        self.surrogate_set = SurrogateFunctionSet([SurrogateFactory.create(name='wasserstein_equalized_odds',
