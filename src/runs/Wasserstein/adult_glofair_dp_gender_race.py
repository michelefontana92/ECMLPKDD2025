...
@register_run('wasserstein_adult_glofair_dp_gender_race')
class WassersteinAdultGlofairDPGenderRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(WassersteinAdultGlofairDPGenderRaceRun, self).__init__(**kwargs)
        self.project_name = 'CentralizedWassersteinAdultGlofairDPGenderRace'
        self.num_clients = 10
        self.lr=1e-4
        ...
        self.training_group_name = 'GenderRace'
        ...
        self.surrogate_set = SurrogateFunctionSet([SurrogateFactory.create(name='wasserstein_demographic_parity',
                                                               ...
                                                               unique_group_ids={
                                                                   self.training_group_name:list(range(4))
                                                                   },
                                                               reduction='mean',
                                                               weight=2
                                                               ),
            ...
            UnconstrainedRequirement(name='unconstraned_performance_requirement',
                    ...
                    ConstrainedRequirement(name='dp_requirement',
                                           metric = MetricsFactory.create_metric(
                                                    ...
                                                    group_name=self.training_group_name,
                                                    group_ids={self.training_group_name:list(range(4))}),
                                            weight=3,
                                            operator='<=',
                                            threshold=0.2),
                        ])
