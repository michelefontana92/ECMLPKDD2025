...
@register_run('wasserstein_adult_glofair_dp_multiple_attributes')
class WassersteinAdultGlofairDPMultipleAttributesRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(WassersteinAdultGlofairDPMultipleAttributesRun, self).__init__(**kwargs)
        self.project_name = 'ConstrainedCentralizedSurrogateAdultGlofairDPMultipleAttributes'
        self.num_clients = 10
        self.lr=1e-4
        ...
        self.surrogate_set = SurrogateFunctionSet([SurrogateFactory.create(name='demographic_parity',
                                                    ...
                                                    SurrogateFactory.create(name='demographic_parity',
                                                               group_name='GenderRace',
                                                               unique_group_ids={
                                                                   'GenderRace':list(range(4))
                                                                   },
                                                               reduction='mean',
                                                               weight=2
                                                               ),
            ...
            UnconstrainedRequirement(name='unconstraned_performance_requirement',
                    ...
                    ConstrainedRequirement(name='dp_requirement',
                                           metric = MetricsFactory.create_metric(
                                                    metric_name='demographic_parity',
                                                    group_name='GenderRace',
                                                    group_ids={'GenderRace':list(range(4))}),
                                            weight=2,
                                            operator='<=',
                                            threshold=0.2),
                        ])
