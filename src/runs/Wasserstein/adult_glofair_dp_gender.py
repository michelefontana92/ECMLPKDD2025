...
@register_run('wasserstein_adult_glofair_dp_gender')
class WassersteinAdultGlofairDPGenderRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(WassersteinAdultGlofairDPGenderRun, self).__init__(**kwargs)
        self.project_name = 'ConstrainedCentralizedWassersteinAdultGlofairDPGender'
        self.num_clients = 10
        self.lr=1e-4
