...
@register_run('wasserstein_adult_glofair_dp_race')
class WassersteinAdultGlofairDPRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(WassersteinAdultGlofairDPRaceRun, self).__init__(**kwargs)
        self.project_name = 'CentralizedWassersteinAdultGlofairDPRace'
        self.num_clients = 10
        self.lr=1e-4
