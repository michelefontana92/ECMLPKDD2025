...
@register_run('adult_fedavg_lr_gender_race')
class AdultFedAvgLRGenderRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultFedAvgLRGenderRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','AdultFedAvgLRGenderRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
