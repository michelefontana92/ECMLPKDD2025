...
@register_run('adult_f1')
class AdultF1(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultF1, self).__init__(**kwargs)
        self.project_name = 'Test'#CentralizedAdultF1Alpha200'
        self.num_clients = 1
        self.lr=1e-4
        ...
        self.surrogate_set = SurrogateFunctionSet([
                                      ...
                                      SurrogateFactory.create(name='demographic_parity',
                                                              ...
                                                              distributed_env=True,
                                                              group_name='Gender',
                                                              unique_group_ids={self.training_group_name:list(range(2))}
                                                              )
                                      ])
