...
@register_run('adult_fedfb_race')
class AdultFedFBRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultFedFBRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','AdultFedFBRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
