...
@register_run('adult_fedfb_gender')
class AdultFedFBGenderRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultFedFBGenderRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','AdultFedFBGenderAlpha2')
        self.num_clients = 10
        self.lr=1e-4
