...
@register_run('adult_fedfb_gender_race')
class AdultFedFBGenderRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultFedFBGenderRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','AdultFedFBGenderRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
