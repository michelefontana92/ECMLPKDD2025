...
@register_run('adult_fedavg_lr_race')
class AdultFedAvgLRRaceRun(AdultRun):
    def __init__(self,**kwargs) -> None:
        super(AdultFedAvgLRRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','AdultFedAvgLRRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
