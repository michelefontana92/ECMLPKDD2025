...
import shutil
from .credit_run import CentralizedCreditRun
...
@register_run('credit_hier_alm')
class CreditHierALMCentralized(CentralizedCreditRun):
    def __init__(self, **kwargs) -> None:
        super(CreditHierALMCentralized, self).__init__(**kwargs)
    ...
    def setUp(self):
        ...
        dataset_name = 'credit'
        path = f'node_{self.start_index}/{dataset_name}' if self.start_index >= 0 else f'{self.dataset}_clean'
