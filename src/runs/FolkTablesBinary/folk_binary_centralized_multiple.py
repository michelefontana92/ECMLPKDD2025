...
@register_run('folk_binary_centralized_multiple')
class FolkTablesBinaryCentralized(FolkTablesBinaryRun):
    def __init__(self,**kwargs) -> None:
        super(FolkTablesBinaryCentralized, self).__init__(**kwargs)
        ...
        perf_surrogate_name = 'performance'
        if self.onlyperf:
            ...
            for metric,group,threshold in zip(self.metrics_list,self.groups_list,self.threshold_list):
                ...
                self.num_groups = self.compute_group_cardinality(group)
