...
import shutil
from .folk_multi_run import FolkTablesMultiRun
...
@register_run('folk_multi_centralized_multiple')
class FolkTablesMultiCentralized(FolkTablesMultiRun):
    def __init__(self,**kwargs) -> None:
        super(FolkTablesMultiCentralized, self).__init__(**kwargs)
        ...
        self.metrics = [MetricsFactory().create_metric('performance',num_classes=self.num_classes)]
