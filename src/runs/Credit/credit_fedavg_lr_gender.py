...
@register_run('credit_fedavg_lr_gender')
class CreditFedAvgLRGenderRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditFedAvgLRGenderRun, self).__init__(**kwargs)
        self.project_name = 'CreditFedAvgLRGender'
        self.num_clients = 10
        self.lr=1e-4
