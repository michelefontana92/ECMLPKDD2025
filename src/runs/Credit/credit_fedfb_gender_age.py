...
@register_run('credit_fedfb_gender_age')
class CreditFedFBGenderAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditFedFBGenderAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditFedFBGenderAge'
        self.num_clients = 10
        self.lr=1e-4
