...
@register_run('credit_fedavg_lr_age')
class CreditFedAvgLRAgeRun(CreditRun):
    def __init__(self,**kwargs) -> None:
        super(CreditFedAvgLRAgeRun, self).__init__(**kwargs)
        self.project_name = 'CreditFedAvgLRAge'
        self.num_clients = 10
        self.lr=1e-4
        self.num_federated_rounds = 100
        self.training_group_name = 'Age'
