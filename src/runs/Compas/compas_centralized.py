...
@register_run('compas_centralized')
class CompasCentralized(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasCentralized, self).__init__(**kwargs)
        self.dataset = 'compas'
        ...
        if self.onlyperf:
            ...
            self.surrogate_set = SurrogateFunctionSet([
                                        SurrogateFactory.create(name=perf_surrogate_name,
                                            ...
                                            SurrogateFactory.create(name=fairness_surrogate_name,
                                                                surrogate_weight=1,
                                                                average='weighted',
                                                                distributed_env=True,
                                                                group_name=self.training_group_name,
