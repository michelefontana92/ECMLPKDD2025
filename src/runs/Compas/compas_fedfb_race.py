...
@register_run('compas_fedfb_race')
class CompasFedFBRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasFedFBRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','CompasFedFBRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
