...
@register_run('compas_fedavg_lr_race')
class CompasFedAvgLRRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasFedAvgLRRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','CompasFedAvgLRRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
