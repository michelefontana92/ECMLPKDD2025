...
@register_run('compas_fedavg_lr_gender_race')
class CompasFedAvgLRGenderRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasFedAvgLRGenderRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','CompasFedAvgLRGenderRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
