...
@register_run('compas_fedavg_lr_gender')
class CompasFedAvgLRGenderRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasFedAvgLRGenderRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','CompasFedAvgLRGenderAlpha2')
        self.num_clients = 10
        self.lr=1e-4
