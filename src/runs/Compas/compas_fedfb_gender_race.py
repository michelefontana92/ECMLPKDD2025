...
@register_run('compas_fedfb_gender_race')
class CompasFedFBGenderRaceRun(CompasRun):
    def __init__(self,**kwargs) -> None:
        super(CompasFedFBGenderRaceRun, self).__init__(**kwargs)
        self.project_name =  kwargs.get('project_name','CompasFedFBGenderRaceAlpha2')
        self.num_clients = 10
        self.lr=1e-4
