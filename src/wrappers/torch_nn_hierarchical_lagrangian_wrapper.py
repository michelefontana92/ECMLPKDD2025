...
import torch
import numpy as np
from wrappers import TorchNNWrapper,TorchNNLagrangianWrapper
...
class SubProblemConfig:
    ...
    def instanciate(self,model):
        ...
        self.instance = TorchNNLagrangianWrapper(model=copy.deepcopy(model),**config)
...
class TorchNNHierarchicalLagrangianWrapper(TorchNNWrapper):
